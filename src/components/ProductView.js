      ...
      <div className="bg-white rounded-lg max-w-6xl w-full max-h-full overflow-auto flex flex-col md:flex-row p-6 relative">
        ...
        <div className="md:w-1/2 mt-6 md:mt-0 md:pl-10 flex flex-col text-left">
          ...
          <div className="flex items-center space-x-4 text-gray-700 font-semibold">
            <span>Share :</span>
            <a href="#" aria-label="Share on Facebook" className="hover:text-blue-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="currentColor"
            ...
            <a href="#" aria-label="Share on Twitter" className="hover:text-blue-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="currentColor"
            ...
            <a href="#" aria-label="Share on Instagram" className="hover:text-pink-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="currentColor"
            ...
            <a href="#" aria-label="Share on LinkedIn" className="hover:text-blue-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="currentColor"
